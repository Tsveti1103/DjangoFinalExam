...
from dog_walks.common.views import index, map_page, like_night, share_night, CreteNightCommentView, like_eat, \
    CreteEatCommentView, share_eat, like_walk, share_walk, CreteWalkCommentView, want_to_visit_night, want_to_visit_eat, \
    want_to_visit_walk, CreateNightReportView, SearchResultsView, CreateEatReportView, CreateWalkReportView, AboutUs, \
    ContactUsView, TermsAndConditions
#
urlpatterns = (
    ...
    path('night/<int:pk>/', include([
        ...
        path('share/', share_night, name='share night'),
    ...
    path('eat/<int:pk>/', include([
        ...
        path('share/', share_eat, name='share eat'),
    ...
    path('walk/<int:pk>/', include([
        ...
        path('share/', share_walk, name='share walk'),
